...
<div class="flex h-screen w-full flex-col">
	...
	<div class="mt-8 flex h-full w-full justify-center gap-x-4 px-8">
		<div class="flex h-fit w-fit flex-col rounded-md bg-[#3b3b3b] px-4 py-2">
			...
			<button class=" rounded-md bg-zinc-900/90 px-2 py-1 font-bold text-zinc-300/90"
				>Export</button
			>

			<span class="mb-1 mt-6 italic text-gray-300">Submit, to delete this entire chat!</span>
			<button class=" rounded-md bg-red-900/90 px-2 py-1 font-bold text-zinc-300/90">Submit</button>
		</div>
	</div>
	<div class="static">
